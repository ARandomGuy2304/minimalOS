...
3. Download the Limine bootloader and create the ISO file via the provided bash script.
   Command: `chmod +x make.sh && ./make.sh` (change the username and password in the bash script if you want, default credentials: username `admin` and password `password123`).
